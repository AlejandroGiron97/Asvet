...
export class ServicesComponent {
  servicios = [
    ...
    { titulo: 'Rayos X', descripcion: '"Disponemos de equipos de rayos X de alta calidad para garantizar un diagnóstico preciso para tu mascota."', imagenUrl: 'img/rax.webp' },
    ...
    { titulo: 'Pet Shop', descripcion: '"Amplia variedad de medicamentos, concentrados premium y accesorios de las mejores marcas."', imagenUrl: 'img/shop.webp' },
